...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private lazy var aboutMenuItem: NSMenuItem = {
        let item = NSMenuItem(title: "About Send Control", action: #selector(showAboutWindow), keyEquivalent: "")
        item.target = self
        return item
    }()
...
private final class AboutContentView: NSView {
    ...
    private func setup() {
        ...
        backgroundLayer.borderColor = NSColor(calibratedWhite: 1.0, alpha: 0.18).cgColor
